...
btn_bracketopen = tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font=("Arial", 14))
btn_bracketopen.grid(row=5, column=1)
btn_bracketclosed= tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("Arial", 14))
btn_bracketclosed.grid(row=5, column=3)
